...
export const ABOUT_TEXT = `I am a dedicated and versatile frontend developer with a passion for creating efficient and user-friendly web applicationsProficient in MERN stack (MongoDB, Express, React, and Node), hands-on experience.
A Good  experience in JavaScript and React Js, with a strong focus on modern web technologies.
one year of experience with  HTML, CSS, Javascript, Mongo database.
Proficient in Microsoft Office Suite, including advanced skills in Excel, Word, and Outlook.
Excellent proficiency in Adobe Creative Suite, including Photoshop, Lightroom, After Effects, and Illustrator.
Freelance work includes website design and development, showcasing versatility and adaptability.
`;
